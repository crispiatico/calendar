...
// Returns the private 'App\Repository\EventoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EventoRepository.php';

return $this->privates['App\Repository\EventoRepository'] = new \App\Repository\EventoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
