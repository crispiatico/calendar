...
// Returns the private 'App\Repository\TopicRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TopicRepository.php';

return $this->privates['App\Repository\TopicRepository'] = new \App\Repository\TopicRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
