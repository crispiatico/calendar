...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\BookingRepository' => function () {
    return ($this->privates['App\Repository\BookingRepository'] ?? $this->load('getBookingRepositoryService.php'));
}, 'App\\Repository\\EventoRepository' => function () {
    return ($this->privates['App\Repository\EventoRepository'] ?? $this->load('getEventoRepositoryService.php'));
}, 'App\\Repository\\PlaceRepository' => function () {
    return ($this->privates['App\Repository\PlaceRepository'] ?? $this->load('getPlaceRepositoryService.php'));
}, 'App\\Repository\\TeacherRepository' => function () {
    return ($this->privates['App\Repository\TeacherRepository'] ?? $this->load('getTeacherRepositoryService.php'));
}, 'App\\Repository\\TopicRepository' => function () {
    return ($this->privates['App\Repository\TopicRepository'] ?? $this->load('getTopicRepositoryService.php'));
...
}, 'App\\Repository\\UsertypeRepository' => function () {
    return ($this->privates['App\Repository\UsertypeRepository'] ?? $this->load('getUsertypeRepositoryService.php'));
}))));
